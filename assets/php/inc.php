...
if (!isset($COPY_LOADED)) {
    ...
    // ============================================================
    // LEGAL copy — vozai.es source, adapted to FIDORA LABS S.L.
    // (FIDORA LABS LLC. is the vozai.es entity; for fidora.io we use
    // FIDORA LABS S.L. as the legal name. Texts otherwise identical.)
    // ============================================================
    $legalCopy = [
        'privacidad' => [
            'es' => [
                ...
                'facts' => [
                    ['Denominación social', 'FIDORA LABS S.L.'],
                    ['Domicilio',          'C/ Ejemplo 123, 28001 Madrid, España'],
                    ['Email de contacto',  'hola@fidora.io'],
                    ['Delegado en Protección de Datos', 'dpo@fidora.io'],
                ],
                'sections' => [
                    ['h' => '', 'p' => 'Con los límites establecidos en la ley, FIDORA LABS S.L. no asume ninguna responsabilidad derivada de la falta de veracidad, integridad, actualización y precisión de los datos o informaciones que contienen sus páginas web.'],
                    ['h' => '', 'p' => 'Los contenidos e información no vinculan a FIDORA LABS S.L. ni constituyen opiniones, consejos o asesoramiento legal de ningún tipo pues se trata meramente de un servicio ofrecido con carácter informativo y divulgativo.'],
                    ['h' => '', 'p' => 'Las páginas de Internet de FIDORA LABS S.L. pueden contener enlaces (links) a otras páginas de terceras partes que FIDORA LABS S.L. no puede controlar. Por lo tanto, FIDORA LABS S.L. no puede asumir responsabilidades por el contenido que pueda aparecer en páginas de terceros.'],
                    ['h' => '', 'p' => 'Los textos, imágenes, sonidos, animaciones, software y el resto de contenidos incluidos en este website son propiedad exclusiva de FIDORA LABS S.L. o sus licenciantes. Cualquier acto de transmisión, distribución, cesión, reproducción, almacenamiento o comunicación pública total o parcial, deberá contar con el consentimiento expreso de FIDORA LABS S.L.'],
                    ['h' => 'Protección de datos de carácter personal según el RGPD', 'p' => 'FIDORA LABS S.L., en aplicación de la normativa vigente en materia de protección de datos de carácter personal, informa que los datos personales que se recogen a través de los formularios del Sitio web se incluyen en los ficheros automatizados específicos de usuarios de los servicios de FIDORA LABS S.L.'],
                    ['h' => '', 'p' => 'La recogida y tratamiento automatizado de los datos de carácter personal tiene como finalidad el mantenimiento de la relación comercial y el desempeño de tareas de información, formación, asesoramiento y otras actividades propias de FIDORA LABS S.L.'],
                    ...
                    ['h' => '', 'p' => 'FIDORA LABS S.L. adopta las medidas necesarias para garantizar la seguridad, integridad y confidencialidad de los datos conforme a lo dispuesto en el Reglamento (UE) 2016/679 del Parlamento Europeo y del Consejo, de 27 de abril de 2016, y la Ley Orgánica 3/2018, de 5 de diciembre, de Protección de Datos y Garantía de los Derechos Digitales (LOPDGDD).'],
                    ['h' => '¿Dónde puedo ejercer mis derechos ARCO-POL?', 'p' => 'El usuario podrá en cualquier momento ejercitar los derechos ARCO-POL: de acceso, oposición, rectificación, cancelación, limitación y portabilidad reconocidos en el citado Reglamento (UE). El ejercicio de estos derechos puede realizarlo el propio usuario a través de email a: hola@fidora.io.'],
                    ['h' => '', 'p' => 'El usuario manifiesta que todos los datos facilitados por él son ciertos y correctos, y se compromete a mantenerlos actualizados, comunicando los cambios a FIDORA LABS S.L.'],
                    ['h' => 'Finalidad del tratamiento de los datos personales', 'p' => 'En FIDORA LABS S.L. trataremos tus datos personales recabados a través del Sitio Web con las siguientes finalidades:'],
                    ...
                    ['h' => '¿Por cuánto tiempo se conservan los datos personales recabados?', 'p' => 'Los datos personales proporcionados se conservarán mientras se mantenga la relación comercial o no solicites supresión y durante el plazo por el cuál pudieran derivarse responsabilidades legales por los servicios prestados.'],
                    ['h' => 'Legitimación', 'p' => 'El tratamiento de tus datos se realiza con las siguientes bases jurídicas que legitiman el mismo:'],
                    ['h' => '', 'p' => '— La solicitud de información y/o la contratación de los servicios de FIDORA LABS S.L., cuyos términos y condiciones se pondrán a tu disposición en todo caso, de forma previa a una eventual contratación.<br>— El consentimiento libre, específico, informado e inequívoco, en tanto que te informamos poniendo a tu disposición la presente política de privacidad.'],
                    ...
                    ['h' => 'Destinatarios de los datos', 'p' => 'Los datos no se comunicarán a ningún tercero ajeno a FIDORA LABS S.L., salvo obligación legal o proveedores de servicio relacionados con la relación contractual.'],
                    ['h' => 'Comunicaciones comerciales', 'p' => 'En aplicación de la LSSI, FIDORA LABS S.L. no enviará comunicaciones publicitarias o promocionales por correo electrónico u otro medio de comunicación electrónica equivalente que previamente no hubieran sido solicitadas o expresamente autorizadas por los destinatarios de las mismas.'],
                    ['h' => '', 'p' => 'En el caso de usuarios con los que exista una relación contractual previa, FIDORA LABS S.L. sí está autorizado al envío de comunicaciones comerciales referentes a productos o servicios de FIDORA LABS S.L. que sean similares a los que inicialmente fueron objeto de contratación con el cliente.'],
            ...
            'en' => [
                ...
                'facts' => [
                    ['Company name',     'FIDORA LABS S.L.'],
                    ['Registered office','C/ Ejemplo 123, 28001 Madrid, Spain'],
                    ['Contact email',    'hello@fidora.io'],
                    ['Data Protection Officer', 'dpo@fidora.io'],
                ],
                'sections' => [
                    ['h' => '', 'p' => 'Within the limits established by law, FIDORA LABS S.L. assumes no responsibility for the lack of truthfulness, completeness, updating and accuracy of the data or information contained in its web pages.'],
                    ['h' => '', 'p' => 'The content and information do not bind FIDORA LABS S.L. and do not constitute opinions, advice or legal counsel of any kind, as this is merely a service offered for information and disclosure purposes.'],
                    ['h' => '', 'p' => 'The FIDORA LABS S.L. website may contain links to other third-party pages that FIDORA LABS S.L. cannot control. Therefore, FIDORA LABS S.L. cannot assume responsibility for the content that may appear on third-party pages.'],
                    ['h' => '', 'p' => 'The texts, images, sounds, animations, software and the rest of the contents included in this website are the exclusive property of FIDORA LABS S.L. or its licensors. Any act of transmission, distribution, assignment, reproduction, storage or public communication, total or partial, must have the express consent of FIDORA LABS S.L.'],
                    ['h' => 'Personal data protection under the GDPR', 'p' => 'FIDORA LABS S.L., in application of current regulations on the protection of personal data, informs that the personal data collected through the forms on the Website are included in the specific automated files of users of the services of FIDORA LABS S.L.'],
                    ['h' => '', 'p' => 'The automated collection and processing of personal data has the purpose of maintaining the commercial relationship and carrying out information, training, advisory and other activities of FIDORA LABS S.L.'],
                    ...
                    ['h' => '', 'p' => 'FIDORA LABS S.L. adopts the necessary measures to guarantee the security, integrity and confidentiality of the data in accordance with Regulation (EU) 2016/679 of the European Parliament and of the Council, of 27 April 2016, and the new Organic Law 3/2018, of 5 December, on the Protection of Personal Data and the Guarantee of Digital Rights (LOPDGDD).'],
                    ['h' => 'Where can I exercise my ARCO-POL rights?', 'p' => 'The user may at any time exercise the ARCO-POL rights: access, opposition, rectification, cancellation, limitation and portability recognised in the aforementioned Regulation (EU). The user may exercise these rights by email to: hello@fidora.io.'],
                    ['h' => '', 'p' => 'The user states that all data provided by them is true and correct, and undertakes to keep it up to date, communicating any changes to FIDORA LABS S.L.'],
                    ['h' => 'Purpose of the processing of personal data', 'p' => 'At FIDORA LABS S.L. we will process your personal data collected through the Website for the following purposes:'],
                    ...
                    ['h' => '', 'p' => '— The request for information and/or the contracting of the services of FIDORA LABS S.L., whose terms and conditions will be made available to you in any case, prior to any contracting.<br>— The free, specific, informed and unequivocal consent, since we inform you by making this privacy policy available, which, after reading it, if you agree, you can accept by means of a declaration or a clear affirmative action.'],
                    ...
                    ['h' => 'Recipients of the data', 'p' => 'The data will not be communicated to any third party outside FIDORA LABS S.L., except under legal obligation or service providers related to the contractual relationship.'],
                    ['h' => 'Commercial communications', 'p' => 'In application of the LSSI, FIDORA LABS S.L. will not send advertising or promotional communications by email or any other equivalent electronic means that have not previously been requested or expressly authorised by the recipients.'],
                    ['h' => '', 'p' => 'In the case of users with whom there is a prior contractual relationship, FIDORA LABS S.L. is authorised to send commercial communications regarding products or services of FIDORA LABS S.L. that are similar to those that were initially the subject of contracting with the customer.'],
            ...
            'de' => [
                ...
                'facts' => [
                    ['Firmenname',       'FIDORA LABS S.L.'],
                    ['Sitz',             'C/ Ejemplo 123, 28001 Madrid, Spanien'],
                    ['Kontakt-E-Mail',   'hello@fidora.io'],
                    ['Datenschutzbeauftragter', 'dpo@fidora.io'],
                ],
                'sections' => [
                    ['h' => '', 'p' => 'Innerhalb der gesetzlichen Grenzen übernimmt FIDORA LABS S.L. keine Verantwortung für die mangelnde Wahrhaftigkeit, Vollständigkeit, Aktualisierung und Genauigkeit der auf den Webseiten enthaltenen Daten oder Informationen.'],
                    ['h' => '', 'p' => 'Die Inhalte und Informationen sind für FIDORA LABS S.L. nicht verbindlich und stellen keine Meinungen, Ratschläge oder Rechtsberatung jeglicher Art dar, da es sich lediglich um einen zu Informations- und Verbreitungszwecken angebotenen Dienst handelt.'],
                    ['h' => '', 'p' => 'Die Webseiten von FIDORA LABS S.L. können Links zu anderen Seiten Dritter enthalten, die FIDORA LABS S.L. nicht kontrollieren kann. Daher kann FIDORA LABS S.L. keine Verantwortung für die Inhalte auf Seiten Dritter übernehmen.'],
                    ['h' => '', 'p' => 'Die Texte, Bilder, Klänge, Animationen, Software und alle übrigen Inhalte auf dieser Website sind ausschließliches Eigentum von FIDORA LABS S.L. oder seiner Lizenzgeber. Jede Übertragung, Verbreitung, Abtretung, Vervielfältigung, Speicherung oder öffentliche Wiedergabe, ganz oder teilweise, bedarf der ausdrücklichen Zustimmung von FIDORA LABS S.L.'],
                    ['h' => 'Schutz personenbezogener Daten gemäß DSGVO', 'p' => 'FIDORA LABS S.L. informiert in Anwendung der geltenden Vorschriften zum Schutz personenbezogener Daten, dass die über die Formulare der Website erhobenen personenbezogenen Daten in die spezifischen automatisierten Dateien der Nutzer der Dienste von FIDORA LABS S.L. aufgenommen werden.'],
                    ['h' => '', 'p' => 'Die automatisierte Erhebung und Verarbeitung personenbezogener Daten dient der Aufrechterhaltung der Geschäftsbeziehung und der Durchführung von Informations-, Schulungs-, Beratungs- und sonstigen Tätigkeiten von FIDORA LABS S.L.'],
                    ...
                    ['h' => '', 'p' => '— Anfrage nach Informationen und/oder Vertragsabschluss über die Dienste von FIDORA LABS S.L.<br>— Die freie, spezifische, informierte und eindeutige Einwilligung.'],
                    ...
                    ['h' => 'Empfänger der Daten', 'p' => 'Die Daten werden nicht an Dritte außerhalb von FIDORA LABS S.L. weitergegeben, es sei denn, dies ist gesetzlich vorgeschrieben.'],
                    ['h' => 'Werbemeldungen', 'p' => 'In Anwendung des LSSI wird FIDORA LABS S.L. keine Werbe- oder Promotionsmitteilungen per E-Mail versenden, die nicht zuvor von den Empfängern angefordert oder ausdrücklich genehmigt wurden.'],
                    ['h' => '', 'p' => 'Bei Nutzern, mit denen eine vorherige Vertragsbeziehung besteht, ist FIDORA LABS S.L. berechtigt, Werbemitteilungen über Produkte oder Dienstleistungen von FIDORA LABS S.L. zu versenden.'],
        ...
        'cookies' => [
            'es' => [
                ...
                'intro' => 'Esta Política de Cookies es parte de la Política de Privacidad de FIDORA LABS S.L. El acceso y la navegación en el sitio, o el uso de los servicios del mismo, implican la aceptación de las condiciones generales recogidas en nuestro Aviso Legal y en nuestra Política de Privacidad.',
                'facts' => [
                    ['Denominación social', 'FIDORA LABS S.L.'],
                    ['Domicilio',          'C/ Ejemplo 123, 28001 Madrid, España'],
                    ['Email',              'hola@fidora.io'],
                ],
                'sections' => [
                    ...
                    ['h' => '6. Actualizaciones de la Política', 'p' => 'FIDORA LABS S.L. puede actualizar esta política de cookies ocasionalmente para reflejar cambios en las cookies que utilizamos o por otras razones operativas, legales o reglamentarias. Te recomendamos revisarla periódicamente.'],
                    ['h' => '7. Más Información', 'p' => 'Si tienes alguna pregunta sobre nuestra Política de Cookies, puedes contactarnos en hola@fidora.io.'],
                ],
            ],
            'en' => [
                'title' => 'Cookie Policy',
                'intro' => 'This Cookie Policy is part of the Privacy Policy of FIDORA LABS S.L. Accessing and browsing the site, or using its services, implies acceptance of the general conditions set out in our Legal Notice and in our Privacy Policy.',
                'facts' => [
                    ['Company name',      'FIDORA LABS S.L.'],
                    ['Registered office','C/ Ejemplo 123, 28001 Madrid, Spain'],
                    ['Email',             'hello@fidora.io'],
                ],
                'sections' => [
                    ...
                    ['h' => '4. Third-Party Cookies', 'p' => 'Some cookies are set by third-party services that appear on our pages. FIDORA LABS S.L. does not control these third-party cookies and recommends consulting the privacy policies of those external services (Google Analytics, social networks, payment processors, etc.).'],
                    ...
                    ['h' => '6. Policy Updates', 'p' => 'FIDORA LABS S.L. may update this cookie policy occasionally. We recommend reviewing it periodically.'],
                    ['h' => '7. More Information', 'p' => 'If you have any questions about our Cookie Policy, you can contact us at hello@fidora.io.'],
                ],
            ],
            'de' => [
                'title' => 'Cookie-Richtlinie',
                'intro' => 'Diese Cookie-Richtlinie ist Teil der Datenschutzerklärung von FIDORA LABS S.L. Der Zugriff auf und die Nutzung der Website setzen die Annahme der in unserem Impressum und unserer Datenschutzerklärung enthaltenen allgemeinen Bedingungen voraus.',
                'facts' => [
                    ['Firmenname',     'FIDORA LABS S.L.'],
                    ['Sitz',           'C/ Ejemplo 123, 28001 Madrid, Spanien'],
                    ['E-Mail',         'hello@fidora.io'],
                ],
                'sections' => [
                    ...
                    ['h' => '4. Cookies von Drittanbietern', 'p' => 'Einige Cookies werden von Drittanbieterdiensten gesetzt. FIDORA LABS S.L. kontrolliert diese Cookies nicht.'],
                    ['h' => '5. Cookie-Dauer', 'p' => 'Cookies können Sitzungs-Cookies (temporär) oder persistente Cookies (dauerhaft) sein.'],
                    ['h' => '6. Aktualisierungen der Richtlinie', 'p' => 'FIDORA LABS S.L. kann diese Cookie-Richtlinie gelegentlich aktualisieren.'],
                    ['h' => '7. Weitere Informationen', 'p' => 'Bei Fragen kontaktieren Sie uns bitte unter hello@fidora.io.'],
                ],
            ],
        ],
        'aviso-legal' => [
            'es' => [
                ...
                'facts' => [
                    ['Denominación social', 'FIDORA LABS S.L.'],
                    ['Domicilio',          'C/ Ejemplo 123, 28001 Madrid, España'],
                    ['Email de soporte',   'hola@fidora.io'],
                ],
                'sections' => [
                    ['h' => '', 'p' => 'Con los límites establecidos en la ley, FIDORA LABS S.L. no asume ninguna responsabilidad derivada de la falta de veracidad, integridad, actualización y precisión de los datos o informaciones que contienen sus páginas web.'],
                    ['h' => '', 'p' => 'Los contenidos e información no vinculan a FIDORA LABS S.L. ni constituyen opiniones, consejos o asesoramiento legal de ningún tipo pues se trata meramente de un servicio ofrecido con carácter informativo y divulgativo.'],
                    ['h' => '', 'p' => 'Las páginas de Internet de FIDORA LABS S.L. pueden contener enlaces (links) a otras páginas de terceras partes que FIDORA LABS S.L. no puede controlar. Por lo tanto, FIDORA LABS S.L. no puede asumir responsabilidades por el contenido que pueda aparecer en páginas de terceros.'],
                    ['h' => '', 'p' => 'Los textos, imágenes, sonidos, animaciones, software y el resto de contenidos incluidos en este website son propiedad exclusiva de FIDORA LABS S.L. o sus licenciantes. Cualquier acto de transmisión, distribución, cesión, reproducción, almacenamiento o comunicación pública total o parcial, deberá contar con el consentimiento expreso de FIDORA LABS S.L.'],
                    ['h' => '', 'p' => 'Asimismo, para acceder a algunos de los servicios que FIDORA LABS S.L. ofrece a través del sitio web, deberá proporcionar algunos datos de carácter personal. En cumplimiento de lo establecido en el Reglamento (UE) 2016/679 del Parlamento Europeo y del Consejo, de 27 de abril de 2016, le informamos que, mediante la cumplimentación de los presentes formularios, sus datos personales quedarán incorporados y serán tratados en los ficheros de FIDORA LABS S.L. con el fin de poderle prestar y ofrecer nuestros servicios así como para informarle de las mejoras del sitio Web.'],
                    ['h' => '', 'p' => 'Le informamos también de que tendrá la posibilidad en todo momento de ejercer los derechos de acceso, rectificación, cancelación, oposición, limitación y portabilidad de sus datos de carácter personal, de manera gratuita mediante email a: hola@fidora.io.'],
                ],
            ],
            'en' => [
                'title' => 'Legal Notice',
                ...
                'sections' => [
                    ...
                    ['h' => '', 'p' => 'The FIDORA LABS S.L. website may contain links to other third-party pages that FIDORA LABS S.L. cannot control. Therefore, FIDORA LABS S.L. cannot assume responsibility for the content that may appear on third-party pages.'],
                    ['h' => '', 'p' => 'The texts, images, sounds, animations, software and the rest of the contents included in this website are the exclusive property of FIDORA LABS S.L. or its licensors. Any act of transmission, distribution, assignment, reproduction, storage or public communication, total or partial, must have the express consent of FIDORA LABS S.L.'],
                    ['h' => '', 'p' => 'Likewise, to access some of the services offered by FIDORA LABS S.L. through the website, you must provide some personal data. In compliance with Regulation (EU) 2016/679 of the European Parliament and of the Council, of 27 April 2016, we inform you that, by completing these forms, your personal data will be incorporated and processed in the files of FIDORA LABS S.L. in order to provide and offer our services as well as to inform you of improvements to the Website.'],
                    ['h' => '', 'p' => 'We also inform you that you will have the possibility at all times to exercise the rights of access, rectification, cancellation, opposition, limitation and portability of your personal data, free of charge, by email to: hello@fidora.io.'],
                ],
            ],
            'de' => [
                'title' => 'Impressum',
                ...
                'facts' => [
                    ['Firmenname',   'FIDORA LABS S.L.'],
                    ['Sitz',         'C/ Ejemplo 123, 28001 Madrid, Spanien'],
                    ['Support-E-Mail','hello@fidora.io'],
                ],
                'sections' => [
                    ['h' => '', 'p' => 'Innerhalb der gesetzlichen Grenzen übernimmt FIDORA LABS S.L. keine Verantwortung für die mangelnde Wahrhaftigkeit, Vollständigkeit, Aktualisierung und Genauigkeit der Daten oder Informationen auf ihren Webseiten.'],
                    ['h' => '', 'p' => 'Die Inhalte und Informationen sind für FIDORA LABS S.L. nicht verbindlich und stellen keine Meinungen, Ratschläge oder Rechtsberatung jeglicher Art dar.'],
                    ['h' => '', 'p' => 'Die Webseiten von FIDORA LABS S.L. können Links zu anderen Seiten Dritter enthalten, für deren Inhalt FIDORA LABS S.L. keine Verantwortung übernimmt.'],
                    ['h' => '', 'p' => 'Die Texte, Bilder, Klänge, Animationen, Software und alle übrigen Inhalte auf dieser Website sind ausschließliches Eigentum von FIDORA LABS S.L. oder seiner Lizenzgeber.'],
                    ['h' => '', 'p' => 'Um einige der Dienste von FIDORA LABS S.L. zu nutzen, müssen Sie personenbezogene Daten angeben. Gemäß der Verordnung (EU) 2016/679 werden Ihre Daten in die Dateien von FIDORA LABS S.L. aufgenommen, um unsere Dienste anzubieten.'],
                    ['h' => '', 'p' => 'Sie können Ihre Rechte auf Auskunft, Berichtigung, Löschung, Widerspruch, Einschränkung und Übertragbarkeit jederzeit kostenlos per E-Mail an hello@fidora.io ausüben.'],
                ],
            ],
        ],
    ];
